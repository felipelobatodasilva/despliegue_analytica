...
# Preprocesamiento y selección de características con SelectKBest
...
# Configuración del modelo con Regresión Lineal y SelectKBest para seleccionar las 5 mejores características
...
with mlflow.start_run() as run:
    ...
    mlflow.sklearn.log_model(model, "LinearRegressionModel_SelectKBest")
